...
// ─────────────────────────────────────────────────────────────────────────
// VersionBadge — sello discreto con la versión actual + "Actualizar".
// Al tocar la versión abre un panel de novedades. Sirve para que los testers
// sepan qué versión usan, qué cambió, y puedan forzar la última sin caché.
// ─────────────────────────────────────────────────────────────────────────
    ...
    <>
      <div className="mt-6 flex items-center justify-center gap-4">
        <button
          ...
          className="font-mono text-[0.56rem] uppercase tracking-[0.18em] text-paper-dim/60 transition-colors hover:text-paper-dim"
        >
